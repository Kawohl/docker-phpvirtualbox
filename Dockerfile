...
RUN wget http://sourceforge.net/projects/phpvirtualbox/files/phpvirtualbox-5.0-4.zip/download -O phpvirtualbox-5.0-4.zip
RUN unzip phpvirtualbox-5.0-4.zip
RUN mv phpvirtualbox-5.0-4 /var/www
